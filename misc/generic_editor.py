...
ctx.keymap(
    {
        ...
        # Switch Keyboard
        "(stitch | switch keyboard)": [Key("ctrl-cmd-space")],
        # clipboard
        "snatch": Key("cmd-x"),
        "copy": Key("cmd-c"),
        "paste": Key("cmd-v"),
        ...
        # motions
        "double jeep": [Key("up")] * 2,
        "triple jeep": [Key("up")] * 3,
        "quadruple jeep": [Key("up")] * 4,
        "double dune": [Key("down")] * 2,
        "triple doing": [Key("down")] * 3,
        "quadruple doing": [Key("down")] * 4,
        "fish": Key("alt-right"),
        "2 fish": [Key("alt-right")] * 2,
        "3 fish": [Key("alt-right")] * 3,
        "4 fish": [Key("alt-right")] * 4,
        "fame": Key("alt-left"),
        "2 fame": [Key("alt-left")] * 2,
        "3 fame": [Key("alt-left")] * 3,
        "4 fame": [Key("alt-left")] * 4,
        "rides | roy needs | roid": [Key("cmd-right"), Key("left")],
