...
ctx.keymap(
    {
        ...
        "[go] 2 right | 2 fish": [Key("alt-right")] * 2,
        "[go] 3 right | 3 fish": [Key("alt-right")] * 3,
        "[go] 4 right | 4 fish": [Key("alt-right")] * 4,
        "([go] 1 left | fame)": Key("alt-left"),
        "[go] 2 left | 2 fame": [Key("alt-left")] * 2,
        "[go] 3 left | 3 fame": [Key("alt-left")] * 3,
        "[go] 4 left | 4 fame": [Key("alt-left")] * 4,
