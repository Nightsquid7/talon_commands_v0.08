...
talon_alphabet_words = "air bat cap drum each fine gust harp sit jury crunch look made near onyx pit quench red sun trap urge vest whale plex yank zip"
